...
from unit_frequency_utils import unit_counts_to_normalized_frequencies, unit_counts_to_all_raw_frequencies
...
#
# book_to_text: Dict of book title to all the text in that book, appropriately normalized.  May or may not contain whitespace.
def calculate_raw_word_frequencies(book_to_text):
  # This is a list of Counters, one for each word
  book_to_word_counts = [None] * len(book_to_text)
  ...
  return unit_counts_to_all_raw_frequencies(book_to_word_counts)
